...
export function parseStandardURIString(str: string) {
    ...
    // whitespace. Anyway, the Julian Schrömges Beratung app is not known to utilize unencoded
...
/**
 * Parses a specific URI which (supposedly) references a Julian Schrömges Beratung resource
 * (location).
 *
 * @param {(string|undefined)} uri - The URI to parse which (supposedly)
 * references a Julian Schrömges Beratung resource (location).
 * @public
 * @returns {{
 *     contextRoot: string,
 *     hash: string,
