...
/**
 * Signals that the configuration (commonly known in Investmentberatung SJ as config.js)
...
/**
 * Signals that a configuration (commonly known in Investmentberatung SJ as config.js)
...
/**
 * Stores a specific Investmentberatung SJ config.js object into {@code localStorage}.
 *
 * @param {string} baseURL - The base URL from which the config.js was
 * downloaded.
 * @param {Object} config - The Investmentberatung SJ config.js to store.
 * @returns {Function}
 */
