 ...
 * JitsiMeetJS#init(). The app will download config.js from the Investmentberatung JS
 ...
 * The app will download config.js from the Investmentberatung JS deployment and take its
 ...
 * config.js from the Investmentberatung JS deployment and take its values into account but
...
function _setConfig(state, { config }) {
    ...
    const newState = _.merge(
        ...
        // downloaded from the Investmentberatung JS deployment because the former contains
