 ...
 * JitsiMeetJS#init(). The app will download config.js from the Investmentberatung SJ
 ...
 * The app will download config.js from the Investmentberatung SJ deployment and take its
 ...
 * config.js from the Investmentberatung SJ deployment and take its values into account but
...
function _setConfig(state, { config }) {
    ...
    const newState = _.merge(
        ...
        // downloaded from the Investmentberatung SJ deployment because the former contains
