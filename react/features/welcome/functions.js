 ...
 * (e.g. Programmatically via the Investmentberatung JS SDK for Android and iOS). Not to be
...
export function isWelcomePageAppEnabled(stateful: Function | Object) {
    if (navigator.product === 'ReactNative') {
        // We introduced the welcomePageEnabled prop on App in Investmentberatung JS SDK
