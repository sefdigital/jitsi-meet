 ...
 * (e.g. Programmatically via the Investmentberatung SJ SDK for Android and iOS). Not to be
...
export function isWelcomePageAppEnabled(stateful: Function | Object) {
    if (navigator.product === 'ReactNative') {
        // We introduced the welcomePageEnabled prop on App in Investmentberatung SJ SDK
