 ...
 * (e.g. Programmatically via the Julian Schrömges Beratung SDK for Android and iOS). Not to be
...
export function isWelcomePageAppEnabled(stateful: Function | Object) {
    if (navigator.product === 'ReactNative') {
        // We introduced the welcomePageEnabled prop on App in Julian Schrömges Beratung SDK
