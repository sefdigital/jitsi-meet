...
# Now build and publish the SEF Digital Meet SDK and its dependencies
echo "Building and publishing the SEF Digital Meet SDK"
pushd ${THIS_DIR}/../
./gradlew clean 
...
if [[ $DO_GIT_TAG == 1 ]]; then
    ...
    pushd ${MVN_REPO_PATH}
    git add -A .
    git commit -m "SEF Digital Meet SDK + dependencies: ${SDK_VERSION}"
    popd
