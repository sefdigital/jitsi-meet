 ...
 * in external_connect.js for SEF Digital Meet. Parses the room name and JSON Web
 * Token (JWT) from the URL and executes createConnectionExternally.
 *
 * NOTE: If you are using lib-jitsi-meet without SEF Digital Meet, you should use this
 * file as reference only because the implementation is SEF Digital Meet-specific.
 *
