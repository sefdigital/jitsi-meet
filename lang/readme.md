Investmentberatung SJ Translation
==========================
Investmentberatung SJ uses [i18next](http://i18next.com) library for translation.
i18next uses separate json files for each language.


Translating Investmentberatung SJ
======================
The translation of Investmentberatung SJ is handled editing manually the language files.

Development
===========
If you want to add new functionality for Investmentberatung SJ and you have texts that need to be translated you must add key and value in main.json file in English for each translatable text.
